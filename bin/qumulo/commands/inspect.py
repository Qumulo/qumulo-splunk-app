...
class InspectExtentsCommand(qumulo.lib.opts.Subcommand):
    NAME = "inspect_extents"
    DESCRIPTION = "Inspect the extents"
    ...
    @staticmethod
    def main(conninfo, credentials, args):
        print inspect.extents(conninfo, credentials, args.inode)
...
class InspectMetatreeCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument("--begin-offset", type=int, default=None,
            help="Begin offset to start dumping", required=True)

        parser.add_argument("--end-offset", type=int, default=None,
            help="End offset to finish dumping", required=True)
...
class InspectInodeCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument("--begin-inode", type=int, default=None,
            help="Begining inode", required=True)

        parser.add_argument("--end-inode", type=int, default=None,
            help="Ending inode", required=True)
