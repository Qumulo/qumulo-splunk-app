...
class SetUpPostCommand(qumulo.lib.opts.Subcommand):
    ...
    def options(parser):
        ...
        parser.add_argument('--trace-level', type=int,
            default=0, choices=[0, 1, 2, 3, 4, 5],
            help='Level of verbosity. 0 is the QSFS default, 1 is the most '
                 'verbose level, 5 is the least.')
        parser.add_argument('--trace-types', nargs='+', metavar='TYPE',
            help='Types of events to trace')

    @staticmethod
    def main(conninfo, credentials, args):
        trace.set_up(conninfo, credentials, args.all_nodes, args.trace_level,
                     args.trace_types)
